...
import { CheckCircle, CreditCard, DollarSign, Download, Edit, Trash2, User, Users } from 'lucide-react';
import { Separator } from '../ui/separator';
import { Badge } from '../ui/badge';


const CreateSubscriptionCard = ({subscription}) => {
                                ...
                                <div className="flex justify-between items-start flex-wrap sm:flex-unwrap gap-y-5 sm:gap-y-0 mb-4">
                                  ...
                                  <div className="flex gap-2">
                                    <Button
                                      size="sm" 
                                      variant="outline"
                                      className="text-zinc-300 bg-blue-800 hover:bg-zinc-600"
